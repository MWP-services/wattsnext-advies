...
const adviceImage = require('../assets/15-KWH-ADVIES.jpg');

export default function Advies15Hoog({ navigation, route }) {
    ...
    () =>
      createAdvicePayload({
        ...
        advice: {
          ...
          capacity: route?.params?.adviesCapacity ?? '15 kWh batterijopslag (Hoog Voltage)',
