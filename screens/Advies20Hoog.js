...
const adviceImage = require('../assets/20-KWH-ADVIES.jpg');

export default function Advies20Hoog({ navigation, route }) {
    ...
    () =>
      createAdvicePayload({
        ...
        advice: {
          ...
          capacity: route?.params?.adviesCapacity ?? '20 kWh batterijopslag (Hoog Voltage)',
