...
const adviceImage = require('../assets/10-KWH-ADVIES-LAAG.jpg');

export default function Advies10Laag({ navigation, route }) {
    ...
    () =>
      createAdvicePayload({
        ...
        advice: {
          ...
          capacity: route?.params?.adviesCapacity ?? '10 kWh batterijopslag (Laag Voltage)',
