...
const adviceImage = require('../assets/12.5-KWH-ADVIES.jpg');

export default function Advies12_5Hoog({ navigation, route }) {
    ...
    () =>
      createAdvicePayload({
        ...
        advice: {
          ...
          capacity: route?.params?.adviesCapacity ?? '12,5 kWh batterijopslag (Hoog Voltage)',
