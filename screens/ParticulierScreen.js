...
export default function ParticulierScreen({ navigation, route }) {
  ...
  return (
    <View style={styles.container}>
      ...
      <TouchableOpacity
        style={styles.button}
        onPress={() => navigation.navigate('Fase 1', { clientType, aansluiting: '1-fase' })}
      >
      ...
      <TouchableOpacity
        style={styles.button}
        onPress={() => navigation.navigate('Fase 3', { clientType, aansluiting: '3-fase' })}
      >
